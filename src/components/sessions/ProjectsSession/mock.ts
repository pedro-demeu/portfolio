    ...
    projects: [
      {
        ...
        descricao: "Desenvolvimento de interfaces intuitivas e responsivas para uma plataforma de videomonitoramento, garantindo alta performance e experiência do usuário.",
        tecnologias: [
          { id: 1, name: "React" },
      ...
      },
      {
        ...
        descricao: "Construção de uma plataforma de e-commerce escalável, com foco em usabilidade, performance e arquitetura limpa.",
        tecnologias: [
          { id: 1, name: "React" },
          { id: 2, name: "TypeScript" },
          { id: 4, name: "Next.js" },
      ...
      },
      {
        ...
        descricao: "Desenvolvimento deste site de portfólio para exibir habilidades, projetos e jornada profissional.",
        tecnologias: [
          { id: 1, name: "React" },
          { id: 2, name: "TypeScript" },
          { id: 3, name: "Material-UI" }
      ...
      },
      {
        ...
        descricao: "Aplicativo para gerenciamento de tarefas com funcionalidades como criação, edição e conclusão de tasks.",
        tecnologias: [
          { id: 1, name: "React" },
          { id: 2, name: "TypeScript" },
          { id: 6, name: "Firebase" }
